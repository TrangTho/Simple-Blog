...
public class ListController extends HttpServlet {
    ...
    private static final String SUCCESS = "listBlog.jsp";
    private static final String INVALID = "listBlog.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ArticleDTO> result = dao.loadListArticle(iCurrentPage, 20);
            ...
            if (result != null) {
                url = SUCCESS;
                request.setAttribute("NUMBERPAGE", loadPage);

            } else {
                url = INVALID;
                request.setAttribute("INVALID", "List article is empty");
            }

...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light navF" id="ftco-navbar" style="z-index: 10;">
            <div class="container">
        ...
        <div class="container">
            <form action="MainController" style="position: relative;" method="POST">
                <p style="margin-top: 70px;">TITLE: </p>
                <input style="width: 80%;" class="form-control" type="text" name="txtSearchTitle" value="${param.txtSearchTitle}" /><br/>

                <p >STATUS: </p>
                <select style="width: 80%;margin-top: 5px;height: 35px;" name="txtStatus">
                ...
                <input type="hidden" name="txtPage" value="1"/>
                <input style="position: absolute; top: 70px; right: 20px; width: 190px;" class="btn btn-primary" type="submit" value="Search Title and Status" name="action" /><br/>
            </form>
        </div>
        ...
        <div  >
            ...
            <c:set var="searchValue" value="${param.txtSearchTitle}"/>
                ...
                <c:if test="${not empty loadPage.listActicle}">
                    ...
                    <div style="text-align: center;">
                        <c:forEach var="i" begin="1" end="${loadPage.totalPage}" step="1">
                            <a href="MainController?action=Search Title and Status&txtSearchValue=${searchValue}&txtPage=${i}">${i}</a>
                        </c:forEach>
                    </div>
                </c:if>
            ...
            <c:if test="${requestScope.INVALID != null}">
                <h1 class="text-center">${requestScope.INVALID.titleError}</h1>
            </c:if>
